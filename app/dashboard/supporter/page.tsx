    ...
    <div className="min-h-screen bg-[#f8fafc] flex" dir="rtl">
      ...
      `}>
        <div className="px-6 py-6 border-b border-white/10">
          ...
          <p className="text-xs text-white/50 mt-1">لوحة الداعم</p>
        </div>
            ...
            <>
              ...
              <div className="bg-white rounded-2xl border border-[#e6edf5] p-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-[#273347]/50">احصل على توصيات استثمارية مخصصة لك</p>
                </div>
                <Link
                  href="/chat"
